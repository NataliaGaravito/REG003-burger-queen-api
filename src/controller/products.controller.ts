...
const getAllProducts = async (
  ...
  try {
    ...
    if (
      fetchedProducts.pagination.prev !== null &&
      fetchedProducts.pagination.next !== null
    ) {
      return res
        .links({
          next: url + fetchedProducts.pagination.next,
          prev: url + fetchedProducts.pagination.prev,
          first: url + fetchedProducts.pagination.first,
          last: url + fetchedProducts.pagination.last
        })
        .status(200)
        .json(fetchedProducts.allProducts);
    } else if (fetchedProducts.pagination.prev !== null) {
      return res
        .links({
          prev: url + fetchedProducts.pagination.prev,
          first: url + fetchedProducts.pagination.first,
        ...
        .status(200)
        .json(fetchedProducts.allProducts);
    } else if (fetchedProducts.pagination.next !== null) {
      return res
        .links({
          next: url + fetchedProducts.pagination.next,
          first: url + fetchedProducts.pagination.first,
